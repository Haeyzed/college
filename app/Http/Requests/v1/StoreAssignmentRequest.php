...
/**
 * Store Assignment Request - Version 1
 *
 * This request class handles validation for creating new assignments
...
class StoreAssignmentRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pass_marks' => ['required', 'numeric', 'min:0', 'max:total_marks'],
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'status' => $this->status ?? 1, // Default to active
        ]);
    }
}
