...
/**
 * Store Application Request - Version 1
 *
 * This request class handles validation for creating new applications
...
class StoreApplicationRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            // Basic Information
            'registration_no' => ['nullable', 'string', 'max:255', 'unique:applications,registration_no'],
            ...
            // Personal Details
            'gender' => ['required', 'integer', Rule::in([1, 2, 3])], // 1=Male, 2=Female, 3=Other
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'apply_date' => $this->apply_date ?? now()->toDateString(),
        ]);
    }
}
