...
use App\Http\Controllers\v1\ApplicationSettingsController;
use App\Http\Controllers\v1\MailSettingsController;
use App\Http\Controllers\v1\SmsSettingsController;
use App\Http\Controllers\v1\SocialSettingsController;
use App\Http\Controllers\v1\SystemSettingsController;
use App\Http\Controllers\v1\IdCardSettingsController;
use App\Http\Controllers\v1\MarksheetSettingsController;
use App\Http\Controllers\v1\PrintSettingsController;
use App\Http\Controllers\v1\TaxSettingsController;
use App\Http\Controllers\v1\ScheduleSettingsController;
use App\Http\Controllers\v1\TopbarSettingsController;
...
Route::prefix('v1')->group(function () {
    ...
    // Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::prefix('library')->group(function () {
            ...
            // Book Categories
            Route::get('/categories', [LibraryController::class, 'getBookCategories']);
            Route::post('/categories', [LibraryController::class, 'createBookCategory']);
            Route::get('/categories/{id}', [LibraryController::class, 'getBookCategory']);
            Route::put('/categories/{id}', [LibraryController::class, 'updateBookCategory']);
            Route::delete('/categories/{id}', [LibraryController::class, 'deleteBookCategory']);
            
            // Book Requests
            Route::get('/requests', [LibraryController::class, 'getBookRequests']);
            Route::post('/requests', [LibraryController::class, 'createBookRequest']);
            Route::get('/requests/{id}', [LibraryController::class, 'getBookRequest']);
            Route::put('/requests/{id}', [LibraryController::class, 'updateBookRequest']);
            Route::delete('/requests/{id}', [LibraryController::class, 'deleteBookRequest']);
            
            // Book Issues/Returns
            Route::post('/issue', [LibraryController::class, 'issueBook']);
            Route::post('/return', [LibraryController::class, 'returnBook']);
            Route::get('/issues', [LibraryController::class, 'getBookIssues']);
            
            // Bulk Operations
            Route::post('/bulk/books/status', [LibraryController::class, 'bulkUpdateBookStatus']);
            Route::post('/bulk/categories/status', [LibraryController::class, 'bulkUpdateBookCategoryStatus']);
            Route::post('/bulk/requests/status', [LibraryController::class, 'bulkUpdateBookRequestStatus']);
            Route::post('/bulk/books/delete', [LibraryController::class, 'bulkDeleteBooks']);
            Route::post('/bulk/categories/delete', [LibraryController::class, 'bulkDeleteBookCategories']);
            Route::post('/bulk/requests/delete', [LibraryController::class, 'bulkDeleteBookRequests']);
            
            // Import/Export
            Route::post('/import/books', [LibraryController::class, 'importBooks']);
            Route::get('/import/template/books', [LibraryController::class, 'getBookImportTemplate']);
            
            // ID Card Settings
            Route::get('/id-card-setting', [LibraryController::class, 'getIdCardSetting']);
            Route::post('/id-card-setting', [LibraryController::class, 'updateIdCardSetting']);
        });
